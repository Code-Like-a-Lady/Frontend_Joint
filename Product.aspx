<%@ Page Title="" Language="C#" MasterPageFile="~/MaskInc.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Group_MaskInc_FrontEnd.Product" %>
            ...
            <div class="section-top-border">
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        ...
                        <div class="mt-10">
                            <asp:Button ID="btn_AddProduct" runat="server" Text="Add Product" class="genric-btn primary-border" OnClick="AddProducts_Click" />
                        </div>
                        <div class="mt-10">
                         ...
                         <div class="mt-10">
                            <asp:Button ID="btn_EditProduct" runat="server" Text="Edit Product" class="genric-btn primary-border" OnClick="EditProducts_Click" />
                        </div>
